...
class SupplierInvoiceAnalysis(models.Model):
    _name = "account.supplier_invoice_analysis"
    _description = "Supplier Invoice Analysis"
    _auto = False
    ...
    type = fields.Selection(
        string="Type",
        selection=[
            ("out_invoice", "Supplier Invoice"),
            ("in_invoice", "Supplier Invoice"),
            ("out_refund", "Supplier Refund"),
    ...
    def _where(self):
        where_str = """
        WHERE 1 = 1 AND
            (a.type = 'in_invoice' OR a.type = 'in_refund')
        """
        return where_str
